...
// Ejemplo de inicialización global (o en main/start)
Camera camera(glm::vec3(0.0f, 0.0f, 0.0f));  // Altura de 1.7 para "altura de ojos"
...
void mouse_callback(GLFWwindow* window, double xpos, double ypos)
{
	...
	float yoffset = lastY - (float)ypos; // invertir eje Y
